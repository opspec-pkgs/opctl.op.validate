[![build](https://github.com/opspec-pkgs/opctl.op.validate/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/opctl.op.validate/actions/workflows/build.yml)
